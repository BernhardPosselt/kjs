...
declare class BaseActorDelta {
     ...
     */
    static "__#7@#mergeEmbeddedCollections"(documentClass: typeof Document, baseData: object, deltaData: object): void;
    /**
     ...
     * @returns {object[]}
     */
    static "__#7@#mergeEmbeddedCollection"(base?: object[], delta?: object[]): object[];
    /** @override */
