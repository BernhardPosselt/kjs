...
/**
 * Define the occlusion mode for a given scene.
 */
export type TOKEN_OCCLUSION_MODES = Readonly<number>;
/**
 * Define the occlusion mode for a given scene.
...
export const TOKEN_OCCLUSION_MODES: Readonly<{
    /**
     * Turns off token occlusion.
     */
    NONE: 0;
    /**
     * Owned tokens are occluded.
     */
    OWNED: 1;
    /**
     * Controlled tokens are occluded.
     */
    CONTROLLED: 2;
    /**
     * Visible tokens are occluded regardless of control or ownership.
     */
    VISIBLE: 3;
}>;
/**
 ...
 */
export type COMBAT_ANNOUNCEMENTS = string[];
/**
 * The combat announcements.
 * @enum {string[]}
 */
