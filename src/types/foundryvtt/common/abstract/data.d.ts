...
export default class DataModel {
     ...
     * @returns {string}
     */
    static formatValidationErrors(errors: object, { label, namespace }?: {
        label?: string;
        namespace?: string;
    }): string;
    /**
     ...
     * @private
     */
    private static "__#6@#updateData";
    /**
     ...
     * @private
     */
    private static "__#6@#updateField";
    /**
     ...
     * @returns {DataModel}
     */
    static fromSource(source: object, { strict, ...context }?: DataValidationOptions): DataModel;
    /**
