export const builtInTableNodes: import("prosemirror-tables").TableNodes;
...
export namespace tableCellComplex {
    ...
    export function toDOM_9(node: any): any[];
...
export namespace tableCellComplexBlock {
    ...
    export function toDOM_10(node: any): any[];
...
export namespace tableHeaderComplex {
    ...
    export function toDOM_11(node: any): any[];
...
export namespace tableHeaderComplexBlock {
    ...
    export function toDOM_12(node: any): any[];
