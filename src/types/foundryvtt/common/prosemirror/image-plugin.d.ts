...
export default class ProseMirrorImagePlugin extends ProseMirrorPlugin {
     ...
     * @protected
     */
    protected _onPaste(view: EditorView, event: ClipboardEvent): boolean;
    /**
     ...
     * @protected
     */
    protected _replaceBase64Images(view: EditorView, html: string, images: [full: string, mime: string, data: string][]): Promise<void>;
    /**
